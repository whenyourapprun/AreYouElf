...
import 'package:are_you_elf/service/detector_service.dart';
import 'package:are_you_elf/widgets/box_widget.dart';
import 'package:are_you_elf/widgets/stats_widget.dart';
...
class _DetectorWidgetState extends State<DetectorWidget>
  ...
  // This is nullable because acquiring a [Detector] is an asynchronous operation.
  // This value is `null` until the detector is initialized.
  Detector? _detector;
  ...
  void _initializeCamera() async {
    ...
    _cameraController = CameraController(
      cameras[0], // cameras[0] for back-camera
      // ResolutionPreset.medium,
      ResolutionPreset.low, // low 낮추니까 잘 됨
      enableAudio: false,
